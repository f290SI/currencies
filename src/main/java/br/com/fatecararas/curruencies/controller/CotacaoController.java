...
public class CotacaoController {
    ...
    public Moedas converterParaMoedas(HttpResponse<String> httpResponse) throws JsonProcessingException {
        var mapper = new ObjectMapper();
        ObjectNode jsonNodes = mapper.readValue(httpResponse.body(), ObjectNode.class);
